            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <section className="space-y-4" aria-labelledby="input-heading">
                    ...
                    <label htmlFor="url-input" className="sr-only">
                        {mode === 'encode' ? 'Enter text to encode' : 'Enter URL to decode'}
                    </label>
                    <textarea
                        id="url-input"
                        value={input}
                ...
                <section className="space-y-4" aria-labelledby="output-heading">
                    ...
                    <label htmlFor="url-output" className="sr-only">
                        {mode === 'encode' ? 'Encoded URL result' : 'Decoded text result'}
                    </label>
                    <textarea
                        id="url-output"
                        value={output}
                    ...
                    {output && (
                        <div className="sr-only" aria-live="polite" aria-atomic="true">
                            URL {mode === 'encode' ? 'encoded' : 'decoded'} successfully. {output.length} characters.
                        </div>
                    )}
                </section>
            </div>
